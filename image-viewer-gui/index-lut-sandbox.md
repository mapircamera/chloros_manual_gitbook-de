...
So arbeiten Sie mit einem Index in der Sandbox des Bildbetrachters <img src="../.gitbook/assets/icon_image-viewer.JPG" alt="" data-size="line"> Sandbox zu arbeiten:
...
1. Klicken Sie auf die <img src="../.gitbook/assets/image.png" alt="" data-size="line"> Schaltfläche „+LUT hinzufügen“
...
Die **Klassensteuerung** bestimmt, wie viele diskrete Farbschritte in Ihrem Farbverlauf angezeigt werden:
...
* **20+ Klassen**: Nahezu kontinuierlich, maximale Glätte
...
* **Weniger Klassen** (3–5): Erzeugt deutliche Zonen, vereinfachte Klassifizierung, leichter zu unterscheidende Kategorien.
...
* **Viele Klassen (15–20)**: Wissenschaftliche Analyse, detaillierte Inspektion, Ergebnisse in Publikationsqualität

### Feinabstimmung der Wertebereiche

Die **Wertebereichssteuerungen** legen fest, welche Indexwerte welchen Farben in Ihrem Farbverlauf zugeordnet werden:

**Bereichssteuerungen im LUT-Bedienfeld:**

* **Mindestwert**: Untergrenze der Farbskala
* **Höchstwert**: Obergrenze der Farbskala
* **Zwischenwerte**: Automatische Verteilung zwischen Min und Max (basierend auf der Klassenanzahl)

#### Anpassen der Minimal-/Maximalwerte

**So passen Sie die Wertebereiche an:**

1. Suchen Sie im LUT-Panel die Eingabefelder **Minimalwert** und **Maximalwert**.
...
* **Vollständiger Bereich**: `-1.0` bis `1.0` (alle möglichen Werte anzeigen)
* **Auf Vegetation fokussiert**: `0.2` bis `0.9` (blanker Boden und Wasser ausschließen)
...
* **Benutzerdefinierter Bereich**: Passen Sie die Werte anhand Ihrer beobachteten Pixelwerte an

**Warum sollten Sie die Bereiche anpassen?**

* **Erhöhen Sie den Kontrast** in Ihrem Interessengebiet
...
Wenn Pixelwerte außerhalb Ihres definierten Mindest-/Höchstbereichs liegen, können Sie mithilfe von **Abschneidemodi** steuern, wie sie angezeigt werden.

#### **Verfügbare Optionen für den Abschneidemodus:**
...
* **Anwendungsfall**: Dezente Hervorhebung, Beibehaltung des Kontexts bei gleichzeitiger Hervorhebung interessanter Bereiche
...
* Pixel **außerhalb des Bereichs** zeigen das **ursprüngliche multispektrale Bild**
* Pixel **innerhalb des Bereichs** zeigen einen **Farbverlauf**
...
| **Originalhintergrund**    | Berichte, Präsentationen, intuitive Analyse | Farbe im Bereich, außerhalb davon Foto |
...
1. Suchen Sie im LUT-Bedienfeld die **Farbverlaufs-Vorschauleiste**.
...
* **Halt hinzufügen**: Klicken Sie auf das Symbol „+“, um am Ende ein neues Farbfeld hinzuzufügen.
* **Halt entfernen**: Doppelklicken Sie auf das Farbfeld, um es zu entfernen.
...
* **Clipping ändern** → Die Hintergrundanzeige ändert sich sofort
* **Farben bearbeiten** → Der benutzerdefinierte Farbverlauf wird sofort angewendet
...
Das Verständnis der tatsächlichen Pixelwerte ist entscheidend für die Einstellung effektiver LUT-Bereiche:
...
* **Ausschnitt**: „Originalhintergrund“, um den Boden in natürlicher Farbe zu sehen
